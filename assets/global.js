var cartPageActive = false,
    cartPage = $('body.template-cart');
if ($(cartPage).length) {cartPageActive = true}
if (cartPageActive) {
...
if (cartPageActive) { 
  Shopify.Cart.ShippingCalculator.show({
    submitButton: window.cartStrings.shippingCalcSubmitButton,
    submitButtonDisabled: window.cartStrings.shippingCalcSubmitButtonDisabled,
    customerIsLoggedIn: window.cartStrings.shippingCalcCustomerIsLoggedIn,
    moneyFormat: window.cartStrings.shippingCalcMoneyFormat
  });
}
